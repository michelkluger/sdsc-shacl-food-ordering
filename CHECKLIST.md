...
| **Approach to testing** — evidence valid and invalid submissions were tested | 378 backend + 86 frontend tests. 22 order fixtures across 3 dishes, each invalid one declaring the pointer and constraint it must trigger, exercised in all 5 languages. Integration tests run against real Meilisearch in CI |
