...
from food_api.domain.errors import SearchDegradedError
from food_api.domain.models import SearchResponse
...
async def search_dishes(search: SearchDep, query: SearchQueryDep) -> SearchResponse:
    try:
