...
Negotiation lives here rather than in each route so that "which language is this response in"
has exactly one answer, and so the resolved language can be echoed in ``Content-Language`` on
