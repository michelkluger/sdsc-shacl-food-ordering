 ...
 * an array of enumerated values, a bounded integer, a short enumeration, a date-time - and none
 * of them matches on a field name. That is what keeps the "no dish-specific frontend logic" property
...
import { DateTimeControl, dateTimeTester } from './DateTimeControl'
